...
if(isset($_REQUEST['libraryName']) && !empty($_REQUEST['libraryName'])){
$tableName = $_REQUEST['libraryName'];
$folderName="";


$libraryFolder = (isset($folderName) && !empty($folderName))?$folderName:'queryLib';
...
$libraryDirPath  = dirname(__FILE__).'/library/'.$libraryFolder;

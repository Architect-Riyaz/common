...
if(isset($_POST['loginbutton']))
{
	...
	$quer=mysql_query("SELECT * FROM super_admin WHERE username='$aid' AND password='$password'") or die(mysql_error());
	if($rows=mysql_fetch_array($quer))
	{
		if ((strcasecmp($rows['username'],$aid) == 0) && (strcasecmp($rows['password'],$password) == 0)) {
			 $_SESSION['aid']=$_POST['aid'];
			header("Location:main/adminsInfo.php");
		} 
	}	
		else {		
			session_unset();
...
<head>
	<meta charset="utf-8">
	<title>Login</title>	
	<link href="../dist/css/form.css" rel="stylesheet" type="text/css"/>	
	<!-- jQuery 2.2.3 -->
...
<div style="background: #FFA500;float: left;width: 100%">
	<p style="float: left;font-size: 2pc;padding: 25px;color: #FFF;font-family: fantasy;">Video Link App</p>
	<!--<p style="float: right;padding-right: 25px;padding-top: 18px;"><img src="images/applogo.png" /></p>-->
</div>
<div style="clear: both"></div>
	<div id="login" >
		<h2 style="background: #FFA500;><span class="fontawesome-lock" ></span>Admin Sign In</h2>
		<form action="#" name="lf" method="POST" onsubmit="return validlogin(); ">
			<fieldset>
				...
				<p><input type="submit" value="Sign In" name="loginbutton" style="background: #FFA500;"></p>
